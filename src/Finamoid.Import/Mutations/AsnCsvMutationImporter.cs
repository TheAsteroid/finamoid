...
namespace Finamoid.Import.Mutations
{
    ...
    /// </summary>
    internal class AsnCsvMutationImporter : MutationImporter
    {
        ...
        public override async Task<IEnumerable<Mutation>> ReadAsync(string fullPath)
        {
            ...
            while (await csvReader.ReadAsync())
            {
                ...
                var context = $"File: {fullPath}. Row: {row}. ";
